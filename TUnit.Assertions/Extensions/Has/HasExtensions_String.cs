...
public static partial class HasExtensions
{
    ...
    {
        return new StringLength<TAnd, TOr>(has.AssertionBuilder.AppendCallerMethod(null), has.AssertionBuilder.ConnectorType, has.AssertionBuilder.OtherAssertCondition);
    }
}
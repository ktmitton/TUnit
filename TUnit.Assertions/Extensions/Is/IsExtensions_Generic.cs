...
public static partial class IsExtensions
{
    ...
    {
        return AssertionConditionCombiner.Combine(@is.AssertionBuilder, new EqualsAssertCondition<TActual, TAnd, TOr>(@is.AssertionBuilder.AppendCallerMethod(doNotPopulateThisValue1), expected));
    }
    ...
    {
        return AssertionConditionCombiner.Combine(@is.AssertionBuilder, new EquivalentToAssertCondition<object, TAnd, TOr>(@is.AssertionBuilder.AppendCallerMethod(doNotPopulateThisValue1), expected));
    }
    ...
    public static BaseAssertCondition<object, TAnd, TOr> IsSameReference<TAnd, TOr>(this IIs<object, TAnd, TOr> @is, object expected, [CallerArgumentExpression("expected")] string doNotPopulateThisValue1 = "")
        ...
        where TOr : Or<object, TAnd, TOr>, IOr<object, TAnd, TOr>
    {
        return AssertionConditionCombiner.Combine(@is.AssertionBuilder, new SameReferenceAssertCondition<object, object, TAnd,TOr>(@is.AssertionBuilder.AppendCallerMethod(doNotPopulateThisValue1), expected));
    }
    ...
    {
        return AssertionConditionCombiner.Combine(@is.AssertionBuilder, new NullAssertCondition<TActual, TAnd, TOr>(@is.AssertionBuilder.AppendCallerMethod(string.Empty)));
    }
        ...
        where TOr : Or<TActual, TAnd, TOr>, IOr<TActual, TAnd, TOr>
    {
        return AssertionConditionCombiner.Combine(@is.AssertionBuilder, 
            new TypeOfAssertCondition<TActual, TAnd, TOr>(
                @is.AssertionBuilder.AppendCallerMethod(type.FullName), type));
    }

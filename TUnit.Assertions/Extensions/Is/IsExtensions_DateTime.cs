...
public static partial class IsExtensions
{
    ...
    {
        return AssertionConditionCombiner.Combine(@is.AssertionBuilder, new DelegateAssertCondition<DateTime, DateTime, TAnd, TOr>(@is.AssertionBuilder.AppendCallerMethodWithMultipleExpressions([doNotPopulateThisValue1, doNotPopulateThisValue2]), default, (value, _, _, _) =>
            {
    ...
    public static BaseAssertCondition<DateTime, TAnd, TOr> IsGreaterThan<TAnd, TOr>(this IIs<DateTime, TAnd, TOr> @is, DateTime expected, [CallerArgumentExpression("expected")] string doNotPopulateThisValue = "")
        ...
        where TOr : Or<DateTime, TAnd, TOr>, IOr<DateTime, TAnd, TOr>
    {
        return AssertionConditionCombiner.Combine(@is.AssertionBuilder, new DelegateAssertCondition<DateTime, DateTime, TAnd, TOr>(@is.AssertionBuilder.AppendCallerMethod(doNotPopulateThisValue), default, (value, _, _, _) =>
            {

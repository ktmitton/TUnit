...
public static partial class IsExtensions
{
    ...
    {
        return AssertionConditionCombiner.Combine(@is.AssertionBuilder, new DelegateAssertCondition<DateTimeOffset, DateTimeOffset, TAnd, TOr>(@is.AssertionBuilder.AppendCallerMethodWithMultipleExpressions([doNotPopulateThisValue1, doNotPopulateThisValue2]), default, (value, _, _, _) =>
            {
    ...
    public static BaseAssertCondition<DateTimeOffset, TAnd, TOr> IsGreaterThan<TAnd, TOr>(this IIs<DateTimeOffset, TAnd, TOr> @is, DateTimeOffset expected, [CallerArgumentExpression("expected")] string doNotPopulateThisValue = "")
        ...
        where TOr : Or<DateTimeOffset, TAnd, TOr>, IOr<DateTimeOffset, TAnd, TOr>
    {
        return AssertionConditionCombiner.Combine(@is.AssertionBuilder, new DelegateAssertCondition<DateTimeOffset, DateTimeOffset, TAnd, TOr>(@is.AssertionBuilder.AppendCallerMethod(doNotPopulateThisValue), default, (value, _, _, _) =>
            {

...
public static partial class IsExtensions
{
    ...
    {
        return AssertionConditionCombiner.Combine(@is.AssertionBuilder, new DelegateAssertCondition<TimeSpan, TimeSpan, TAnd, TOr>(@is.AssertionBuilder.AppendCallerMethodWithMultipleExpressions([doNotPopulateThisValue1, doNotPopulateThisValue2]), default, (value, _, _, _) =>
            {
    ...
    public static BaseAssertCondition<TimeSpan, TAnd, TOr> IsEqualToWithTolerance<TAnd, TOr>(this IIs<TimeSpan, TAnd, TOr> @is, TimeSpan expected, TimeSpan tolerance, [CallerArgumentExpression("expected")] string doNotPopulateThisValue1 = "", [CallerArgumentExpression("tolerance")] string doNotPopulateThisValue2 = "")
        ...
        where TOr : Or<TimeSpan, TAnd, TOr>, IOr<TimeSpan, TAnd, TOr>
    {
        return AssertionConditionCombiner.Combine(@is.AssertionBuilder, new DelegateAssertCondition<TimeSpan,TimeSpan,TAnd,TOr>(
    ...
    public static BaseAssertCondition<TimeSpan, TAnd, TOr> IsZero<TAnd, TOr>(this IIs<TimeSpan, TAnd, TOr> @is)
        ...
        where TOr : Or<TimeSpan, TAnd, TOr>, IOr<TimeSpan, TAnd, TOr>
    {
        return AssertionConditionCombiner.Combine(@is.AssertionBuilder, new EqualsAssertCondition<TimeSpan, TAnd, TOr>(@is.AssertionBuilder.AppendCallerMethod(null), TimeSpan.Zero));
    }
    ...
    public static BaseAssertCondition<TimeSpan, TAnd, TOr> IsGreaterThan<TAnd, TOr>(this IIs<TimeSpan, TAnd, TOr> @is, TimeSpan expected, [CallerArgumentExpression("expected")] string doNotPopulateThisValue = "")
        ...
        where TOr : Or<TimeSpan, TAnd, TOr>, IOr<TimeSpan, TAnd, TOr>
    {
        return AssertionConditionCombiner.Combine(@is.AssertionBuilder, new DelegateAssertCondition<TimeSpan, TimeSpan, TAnd, TOr>(@is.AssertionBuilder.AppendCallerMethod(doNotPopulateThisValue), default, (value, _, _, _) =>
            {

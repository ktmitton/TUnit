...
public static partial class IsNotExtensions
{
    ...
    {
        return AssertionConditionCombiner.Combine(isNot.AssertionBuilder, new EqualsAssertCondition<bool, TAnd, TOr>(isNot.AssertionBuilder.AppendCallerMethod(null), false));
    }
    ...
    public static BaseAssertCondition<bool, TAnd, TOr> IsNotFalse<TAnd, TOr>(this IIs<bool, TAnd, TOr> isNot)
        ...
        where TOr : Or<bool, TAnd, TOr>, IOr<bool, TAnd, TOr>
    {
        return AssertionConditionCombiner.Combine(isNot.AssertionBuilder, new EqualsAssertCondition<bool, TAnd, TOr>(isNot.AssertionBuilder.AppendCallerMethod(null), true));
    }
}